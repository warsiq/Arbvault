...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(url('assets/style.css')); ?>" />
      <!-- base:css -->
  <link rel="stylesheet" href="<?php echo e(url('assets/typicons/typicons.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(url('assets/css/vendor.bundle.base.css')); ?>">
  <!-- endinject -->
    ...
    <aside class="sidebar">
      ...
      <header class="sidebar-header">
        <a href="#" class="header-logo">
          <img id="sidebar-logo" src="<?php echo e(url('assets/logo.png')); ?>" alt="Logo" />
        </a>
    ...
    <div class="content-wrapper">
      ...
      <div class="row">
        <div class="col-xl-6 grid-margin stretch-card flex-column"><br>
            <h5 class="mb-2 text-titlecase mb-4">Welcome Back, Mr. <?php echo e(Auth::user()->name); ?> 👋 </h5>
          <div class="row">
...
<script type="module" src="<?php echo e(asset('build/js/app.js')); ?>"></script>
    <script>
...
sidebarToggler.addEventListener('click', toggleSidebar);
    ...
    <script src="<?php echo e(url('assets/script.js')); ?>"></script>
  </body>
</html>
<?php /**PATH C:\Users\PC\Desktop\blockchain-project\resources\views/dashboard.blade.php ENDPATH**/ ?>