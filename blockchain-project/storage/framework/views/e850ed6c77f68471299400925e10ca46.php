...
<body>
    <nav class="navbar">
        <div class="logo">
            <img src="<?php echo e(url('assets/img/logo.png')); ?>" alt="ArbVault Logo">
        </div>
    ...
    <section class="hero fade-in">
        ...
        <div class="floating-icons">
            <img src="<?php echo e(url('assets/img/yellow-icon.png')); ?>" alt="Icon">
            <img src="<?php echo e(url('assets/img/red-icon.png')); ?>" alt="Icon">
            <img src="<?php echo e(url('assets/img/green-icon.png')); ?>" alt="Icon">
            <img src="<?php echo e(url('assets/img/purple-icon.png')); ?>" alt="Icon">
        </div>
        ...
        <div class="hero-buttons">
            <button class="primary-btn"  onclick="window.location.href='<?php echo e(route('login')); ?>'">Get Started</button>
...
<div class="header">
    <div>
        ...
        <div class="social-icons">
            ...
            <img src="<?php echo e(url('assets/img/twitter.png')); ?>" alt="X Logo" style="width: 20px; height: 20px;">
...
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
     ...
     <style>
        ...
        <script src="<?php echo e(url('assets/front-script.js')); ?>"></script>
</section>
</html>

<?php /**PATH C:\Users\PC\Desktop\blockchain-project\resources\views/welcome.blade.php ENDPATH**/ ?>